...
/*   Updated: 2022/05/13 13:54:22 by vhaefeli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fractal_mandelbrot(t_varmlx	*v)
{
	...
	z.r = 0;
	z.i = 0;
	c.r = (v->pxlpos.x - v->cx) * v->scale;
	c.i = (- v->pxlpos.y + v->cy) * v->scale;
	i = 0;
...
void	fractal_julia(t_varmlx *v)
{
	...
	z.r = (v->pxlpos.x - v->cx) * v->scale;
	z.i = (- v->pxlpos.y + v->cy) * v->scale;
	c.i = v->mi;
	c.r = v->mr;
	i = 0;
	while (z.r * z.r + z.i * z.i < 4 && i++ < v->itmax)
...
void	fractal_feather(t_varmlx *v)
{
	...
	z.i = (v->pxlpos.x - v->cx) * v->scale;
	z.r = (- v->pxlpos.y + v->cy) * v->scale;
	c.i = v->mi;
	c.r = v->mr;
	i = 0;
